...
namespace CoffeeCafeProject
{
    public partial class FrmMenu : Form
    {
        ...
        {
            //เอาข้อมูลของรายการที่เลือกไปแสดงที่หน้าจอ แล้วปุ่มบันทึกใช้ไม่ได้ แก้ไขลบใช้ได้
        ...
        {
            //ถามผู้ใช้ก่อนว่าจะลบหรือไม่ ให้เลือก YES/No
            if (MessageBox.Show("ต้องการลบรายการนี้หรือไม่", "ยืนยัน", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
            {
                //ลบออกจาก  database
